...
new class extends Component
{
    ...
    public function updateProfileInformation(): void
    {
        ...
        $validated = $this->validate([
            ...
            'email' => ['required', 'string', 'lowercase', 'email', 'max:190', Rule::unique(User::class)->ignore($user->id)],
            'phone' => ['required', 'string', 'max:30', Rule::unique(User::class)->ignore($user->id)],
        ]);
...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input wire:model="phone" id="phone" name="phone" type="tel" class="mt-1 block w-full" required autocomplete="tel" />
